...
ВАЖНЫЕ ПРАВИЛА — строго соблюдай:
- Пиши ТОЛЬКО слова которые реально были произнесены. Никаких домыслов.
- Если слышишь пение, музыку, фоновый шум без диалога — это НЕ разговор на кассе, верни пустой transcript.
- Если слышишь менее 2 реплик (не настоящий диалог) — верни пустой transcript.
- НЕ придумывай слова и фразы которых не было в записи.

Если нет речи, только шум/музыка/пение/тишина/случайные слова:
{"transcript":"","tone":"neutral","score":50,"summary":"Нет диалога","speakers":[],"events":{},"language":"ru"}"""
