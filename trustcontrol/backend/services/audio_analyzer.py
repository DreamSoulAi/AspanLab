...
━━━ КАЗАХСКАЯ РАЗГОВОРНАЯ РЕЧЬ — НОРМА ━━━
На кассе в Казахстане живая речь звучит неформально. Это НЕ грубость и НЕ мусор:
• Междометия: «ошшш», «ой», «япырай», «ой бай», «ä», «е», «ия», «мм» — живая речь.
• Обращения: «ағай», «апай», «бауырым», «қарағым» — уважительные разговорные формы.
• Шала-казахский (микс рус+каз в одной фразе): «Мынаны бер», «400-ге тең», «ладно» — норма.
• Диалектные формы, сокращения, незавершённые фразы — всё это рабочий разговор.
• «Ашшш, 480 тенге» = кассир называет сумму. Это полноценная транзакция, не мусор.
Если слышна любая из этих форм речи — это РАБОЧИЙ РАЗГОВОР, не IGNORE.
