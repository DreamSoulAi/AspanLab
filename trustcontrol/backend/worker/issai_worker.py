...
DEFAULT_KK_PROMPT = (
    # Разговорные (слитные) формы как реально говорят на кассе — не книжные.
    "Саламатсыз ба! Сәлеметсіз бе! Не аласыз? Тағы не аласыз? Тағы керек пе? "
    "Бір донер, екі бургер, кофе, лаваш, шаурма. Үлкенін бе, кішісін бе? "
    "Соусы қандай? Ащы ма? Болды ма? Барлығы қанша болды? "
    "Наличныйға ма, әлде картамен бе? Каспи бар ма? "
    "Қазір дайын болады, біраз күте тұрыңыз. Рақмет! Сау болыңыз!"
)
