...
class Report(Base):
    ...
    # Финальный балл — единый прозрачный движок (calculate_score).
    # Источник истины для дашборда, аналитики и тревог.
    score           = Column(Integer, nullable=True)

    # GPT-4o-mini-audio анализ (сырые сигналы, для справки)
