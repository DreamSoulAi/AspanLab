...
после фиксов выше передеплоить воркер и прогнать 3 тест-записи (мат, каз.диалог,
тихая цена). Если остаётся — причина в КАЧЕСТВЕ аудио (тихо/далеко/шум) → микрофон.
