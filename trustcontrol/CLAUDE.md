...
- Цены: Старт 15к / Бизнес 30к (до 3 точек) / Поток 60к (до 5) / Сеть от 150к ₸/мес.
  Совпадают с `limits` в `api/locations.py`. Бесплатный период — **7 дней** (НЕ месяц).
...
- WhatsApp-бот (`marketing/whatsapp_autoresponder.py`) называет «от 15 000 ₸», ведёт на
