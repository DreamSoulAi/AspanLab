...
7 ДНЕЙ БЕСПЛАТНО, без карты и обязательств. Цена потом — от 24 990 ₸/мес за точку.
...
3. На вопрос о цене: «7 дней бесплатно, без карты. Дальше — от 24 990 ₸/мес за точку,
   окупается одной пойманной утечкой. Точный тариф под ваш формат Данил подберёт на
   созвоне» — можно назвать «от 19 990 ₸», но НЕ выдумывай других сумм и не торгуйся.
