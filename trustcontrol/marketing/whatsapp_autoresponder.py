...
7 ДНЕЙ БЕСПЛАТНО, без карты и обязательств. Цена потом — от 15 000 ₸/мес за точку.
...
3. На вопрос о цене: «7 дней бесплатно, без карты. Дальше — от 15 000 ₸/мес за точку,
